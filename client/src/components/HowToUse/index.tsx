    ...
    <section id="next" className={style.instructions}>
      <div className={style.container}>
        <InstructionBox floatLeft={true} title="Title">
          ...
          earum repellat officiis architecto cupiditate rerum. Ducimus
          consectetur quae cumque doloribus qui, nulla odio aut veniam, repellat
          sed tempore explicabo in?
        </InstructionBox>
        <hr />
